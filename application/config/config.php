...
|
*/
$config['log_threshold'] = (ENVIRONMENT == 'development') ? 3 : 0; //don't log things in production, it's impossible
...
|
*/
$config['encryption_key'] = (isset($_ENV['secrets']['encryption_key'])) ? $_ENV['secrets']['encryption_key'] : '';
...
|
*/
$config['cookie_prefix']	= 'dreamitapp_';
