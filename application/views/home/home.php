<script type="text/ng-template" id="home.html">
	...
	<div class="background_splitter">
		...
		<div class="container">
			<!-- This provides the row functionality for the wall and the control panel -->
			<div class="wallideas_wrapper row">
				...
				<aside class="control_panel span3" equalise-height-to-dir=".wall">
