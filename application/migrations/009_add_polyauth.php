...
class Migration_add_polyauth extends CI_Migration {
	...
	public function up(){
		...
		//since we don't have complex permission requirements, we can just have simple permissions,
		//we'll be relying mostly on the roles instead
		$default_role_permissions = array(
			...
			'developer'	=> array(
				'developer_read'	=> 'Viewing of developer resources.',
			)
		);
