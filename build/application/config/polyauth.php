...
//This part is quite dumb. But we're constrained by the software and time.
//These variables are the templates for the emails that would be sent for forgotten passwords.

$forgotten_password_email = <<<'EOD'
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"> 
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1.0"/>
		<title>Dream it App Forgotten Password Email</title>
		<style type="text/css">
		...
		<table cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
			<tr>
				<td valign="top" style="padding: 16px;"> 
					...
					<p>You have requested us to help to reset your password. Head to this <a href="http://dreamitapp.com/users/confirm_forgotten_password?user_id={{user_id}}&forgotten_code={{forgotten_code}}">link</a> to reset your password.</p>
...
$config['polyauth'] = array(
	...
	'email_html'			=> true,
	'email_forgotten_password_template'	=> $forgotten_password_email,
	//LOGIN SETTINGS
