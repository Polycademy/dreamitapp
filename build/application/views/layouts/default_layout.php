...
<!--[if gt IE 9]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
		...
		<meta name="google-site-verification" content="qYVFBSH-cRMbtUGEwI5mWWEkoNK1H0UPsfRUYShwuBc" />
		...
		<link rel="stylesheet" href="css/main.1391756319283.css">
		<script src="js/lib/modernizr-2.6.2-respond-1.1.0.min.js"></script>
		<script src="js/config.1391756319283.js"></script>
		<script>
        ...
        <header class="navbar navbar-static-top" ng-controller="HeaderCtrl">
			<div class="container">
				<div class="navbar-inner">
					...
					<ul class="nav">
						<li ng-class="{'active_link': $state.includes('about')}"><a href="about#faq" title="Why use us?">Why use us?</a></li>
